            ...
            <CarouselContent class="">
                <CarouselItem v-for="(data, index) in jumbotronNews" :key="index">
                    <div id="jumbotron" class="overflow-x-hidden">
                        <div class="h-[35rem] flex items-end" :style="{backgroundImage: `url(${data.banner})`, backgroundSize: 'cover', backgroundRepeat: 'no-repeat', backgroundPosition: 'center'}">
                            <div class="p-5 lg:p-10 backdrop-blur-sm">
                                <NuxtLink to="/">
                                    <p class="text-lg lg:text-5xl font-medium text-white">{{ data.title }}</p>
                                </NuxtLink>
                            </div>
                        </div>
                    </div>
...
let jumbotronNews = [
    {
        title: 'Dubai Centre for Family Businesses issues ‘Sample Article of Association for Family Businesses', 
        banner: '/img/Mohammad-Ali.png' 
    },
    {
        title: 'Dubai Centre for Family Businesses successfully concludes two sessions in Governance Series', 
        banner: '/img/CEO-Sustainability-Dialogue-1.jpg' 
    },
    {
        title: 'Dubai Chamber of Commerce reaffirms its commitment to empowering the business community and enhancing its competitiveness to drive economic growth', 
        banner: '/img/Business-Groups-Councils-Quarterly-Roundtable-Meeting-scaled.jpg' 
    },
]
